...
def train(env,
    ...
    with open('D3QN_baseline_nn_concat_rewards.data', 'wb') as file:
        # store the data as binary data stream
        pickle.dump(rewards, file)

    with open('D3QN_baseline_nn_concat_average_rewards.data', 'wb') as file:
        # store the data as binary data stream
        pickle.dump(moving_avg_rewards, file)

    
    with open('D3QN_baseline_nn_concat_losses.data', 'wb') as file:
        # store the data as binary data stream
