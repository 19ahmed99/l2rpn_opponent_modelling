...
class DoubleDuelingDQN_NN(object):
    ...
    def construct_q_network(self):
        input_shape = (self.observation_size * self.num_frames + self.action_vect_size *  self.num_frames,)
    ...
    def predict_move(self, data):
        model_input = data.reshape(1, self.observation_size * self.num_frames + self.action_vect_size * self.num_frames)
